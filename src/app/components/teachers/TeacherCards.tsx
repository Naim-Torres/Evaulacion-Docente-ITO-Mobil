...
export default function TeacherCards({ teacher }: Props) {
    return (
        <div className="group relative overflow-hidden flex items-end h-[300px] sm:h-[360px] md:h-[420px] 2xl:h-[600px] p-4 md:p-6 rounded-lg bg-white shadow-md cursor-pointer duration-300 hover:shadow-lg">
